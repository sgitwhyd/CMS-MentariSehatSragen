         ...
         <div class="card">
            <div class="card-body">
               ...
               <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     <input class="form-control" type="text" id="jabatan" name="jabatan" value="{{$pengurus->jabatan}}" required>
                  </div>
               </div>
               <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                     ...
                     @if($pengurus->image)
                        <img src="{{ asset('storage/' . $pengurus->image) }}" alt="preview-img" class="img-preview img-fluid mb-3 col-sm-5" style="width: 300px;">
                     @endif
                  </div>
               </div>
               <div class="row mb-3">
