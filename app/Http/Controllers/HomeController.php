...
class HomeController extends Controller
{
    public function index()
    {
        ...
        SEOTools::jsonLd()->addImage(asset('storage/'.$sliders[0]->image));
        SEOTools::addImages(asset('storage/'.$sliders[0]->image));
    ...
    {
        SEOTools::setTitle($blog->title . ' - Mentari Sehat Indonesia Kabupaten Sragen') ;
